    ...
    <section id="contact" className="py-10 bg-white dark:bg-black">
      <div className="max-w-6xl mx-auto px-6">
        <span className="block text-center mb-4">
          <span className="inline-block px-4 py-1.5 bg-blue-50 dark:bg-amber-500/10 text-blue-600 dark:text-amber-400 text-sm font-medium rounded-full">📞 Reach Out</span>
        </span>
