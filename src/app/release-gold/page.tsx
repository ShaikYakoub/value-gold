  ...
  return (
    <>
      ...
      <main className="pt-16">
        {/* Hero Section */}
        <section className="relative md:min-h-[500px] bg-gradient-to-br from-blue-600 to-blue-800 dark:from-amber-600 dark:to-amber-800 flex items-center justify-center py-4 md:py-12">
